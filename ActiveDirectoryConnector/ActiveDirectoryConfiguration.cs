...
namespace Org.IdentityConnectors.ActiveDirectory
{
    public class ActiveDirectoryConfiguration : Org.IdentityConnectors.Framework.Spi.AbstractConfiguration
    {
        ...
        [ConfigurationProperty(Confidential = false, DisplayMessageKey = "display_discoverEventLog", HelpMessageKey = "help_discoverEventLog", Order = 16)]
        public bool DiscoverEventLog { get; set; }

        [ConfigurationProperty(Confidential = false, DisplayMessageKey = "display_EventLogComputerName", HelpMessageKey = "help_EventLogComputerName", Order = 17)]
        public String EventLogComputerName
        { get; set; }

        [ConfigurationProperty(Confidential = false, DisplayMessageKey = "display_EventLogDomainName", HelpMessageKey = "help_EventLogDomainName", Order = 18)]
        public String EventLogDomainName
        { get; set; }

        [ConfigurationProperty(Confidential = false, DisplayMessageKey = "display_EventLogUserName", HelpMessageKey = "help_EventLogUserName", Order = 19)]
        public String EventLogUserName
        { get; set; }

        [ConfigurationProperty(Confidential = true, DisplayMessageKey = "display_EventLogUserPassword",
        Required = false, HelpMessageKey = "help_EventLogUserPassword", Order = 20)]
        public String EventLogUserPassword
        { get; set; }

        [ConfigurationProperty(Confidential = true, DisplayMessageKey = "display_OnAccountCreateTolerateGroups",
        Required = false, HelpMessageKey = "help_OnAccountCreateTolerateGroups", Order = 21)]
        public bool OnAccountCreateTolerateGroups
        { get; set; }
        ...
        public ActiveDirectoryConfiguration()
        {
            ...
            LDAPHostName = "";
            OnAccountCreateTolerateGroups = false;
        }
